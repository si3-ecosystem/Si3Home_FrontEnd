          ...
          <div className="grid grid-cols-1 justify-center md:grid-cols-2 lg:grid-cols-3 m-4 md:m-[4rem] mb-10 md:gap-[30px] pb-20">
            {currentCards.map((card, index) => (
              <motion.div
                ...
                className="card mx-auto p-[25px] flex flex-col justify-between my-4 lg:w-[412px] lg:h-[549px] w-[300px] h-[446px] border-[2px] border-[#f488b0] rounded-xl md:h-[500px] md:w-[360px]"
              >
