    ...
    return (
        <div className="fixed top-0 bg-[rgba(0,0,0,0.4)] p-4 left-0 w-full h-full flex items-center justify-center">
            <div className="p-4 sm:p-8 flex-1 max-w-[400px] rounded-lg bg-white min-h-[200px]">
                ...
                <p className="font-mono text-center text-sm my-4">Congratulations! you have successfully submitted a membership form and we have received your request, we would get back to you as soon as we can </p>
                <Link href={"/"}>
