import { DiversityTrackerFormData, NewMemberData, TabValues } from "@/lib/types/interfaces";
...
export default function useDiversityTrackerForm(){
    ...
    const handleSubmit:FormEventHandler<HTMLFormElement> = async(e)=>{
        ...
        try {
            setLoading(true)
            const {error,message} = await ContentProvider.addDiversityTracker(formData)
            if(error){
