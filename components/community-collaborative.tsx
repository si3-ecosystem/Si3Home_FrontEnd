      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="w-full lg:px-0 lg:ml-auto md:flex overflow-hidden   ">
          ...
          >
            {community?.length > 0 &&
              community
                ?.filter((item: any) => !item._id.startsWith("drafts."))
                    ...
                    <div className=" overflow-hidden w-full h-fit flex items-start gap-4">
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <div className="flex items-center gap-1 text-[#404040] max-lg:text-sm">
                          <MapPin className="w-4" /> {item.communityLocation}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3 mt-6 h-full w-full flex flex-col justify-between ">
                      <div className="flex flex-col gap-3">
                        ...
                        <div className="flex flex-col justify-between h-full">
                          ...
                          <Link
                            href={item?.discover || "#"}
                            className="w-full  text-center mt-16 py-3.5 px-6 hover:bg-black hover:text-white rounded-full border border-black hover:border-[#B668E4] "
                          >
                            Discover
                          </Link>
                        </div>
