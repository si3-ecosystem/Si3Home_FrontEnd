      ...
      <div className="py-14 md:py-28 ">
        <div className="px-5 md:px-16">
          ...
          <p className="font-mono my-4 md:my-6 text-[#999999]">
            Connect with our members for speaking opportunities, collaborations,
            and more.
          </p>
        </div>
            ...
            >
              <div className="">
                <Image
                  ...
                  width={440}
                  height={340}
                  className="w-[440px] h-[340px] object-cover object-center rounded-lg"
                />
              </div>

              <div className="flex flex-col justify-between gap-12">
                <div className="space-y-3 mt-6">
                  <h3 className=" text-3xl">KARA HOWARD</h3>
