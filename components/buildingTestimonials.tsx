...
import BuildingSingleTestimonial from "./buildingSingleTestimonial";

export default function BuildingTestimonials({ testimonials }: any) {
            ...
            >
              {testimonials
                ...
                .map((item: any, key: number) => (
                  ...
                  >
                    <BuildingSingleTestimonial testimonial={item} />
                  </SwiperSlide>
                ))}
            </Swiper>
          </div>
